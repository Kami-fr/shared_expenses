...
const EN = {
  ...
  dashboard_on_hint:
    "A sensor per member, and one saying whether anything is still owed. Readable by every account in the house — not only by the people in this group.",
...
const FR: Record<Key, string> = {
  ...
  dashboard_on_hint:
    "Un capteur par membre, et un qui dit s'il reste quelque chose dû. Lisibles par tous les comptes de la maison — pas seulement par les gens de ce groupe.",
