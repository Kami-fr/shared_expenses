...
const EN = {
  ...
  rate_service_unreachable:
    "The rate service could not be reached. Type a rate to carry on: it will be kept for next time.",
  rate_unknown_currency:
    "The rate service does not carry this pair of currencies. Type a rate to carry on: it will be kept for next time.",
  paid_by: "Paid by",
  date: "Date",
  category: "Category",
  ...
  split_both_amount_and_share:
    "The same person is down for both an amount and a percentage.",
  ...
  confirm_leave_entry:
    "Leave this and open that one? What has been typed here is not saved.",
  split: "Split",
  edit_split: "Change",
  done: "Done",
...
const FR: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "Le service de taux est injoignable. Saisissez un taux pour continuer : il servira de référence.",
  rate_unknown_currency:
    "Le service de taux ne couvre pas ces deux devises. Saisissez un taux pour continuer : il servira de référence.",
  paid_by: "Payé par",
  date: "Date",
  category: "Catégorie",
  ...
  split_unknown_member:
    "Quelqu'un dans cette répartition ne fait plus partie du groupe.",
  split_fixed_negative:
    "Un montant de la répartition ne peut pas être négatif.",
  split_percent_negative:
    "Un pourcentage de la répartition ne peut pas être négatif.",
  split_remainder_nobody: "Il ne reste personne pour prendre le reste.",
  split_both_amount_and_share:
    "La même personne est inscrite à la fois pour un montant et pour un pourcentage.",
  ...
  confirm_leave_entry:
    "Quitter et ouvrir celle-là ? Ce qui a été saisi ici n'est pas enregistré.",
  split: "Répartition",
  edit_split: "Modifier",
  done: "Terminé",
...
const DE: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "Der Kursdienst ist nicht erreichbar. Gib einen Kurs ein, um fortzufahren: er dient als Referenz.",
  rate_unknown_currency:
    "Der Kursdienst führt dieses Währungspaar nicht. Gib einen Kurs ein, um fortzufahren: er dient als Referenz.",
  paid_by: "Bezahlt von",
  date: "Datum",
  category: "Kategorie",
  ...
  split_unknown_member:
    "Jemand in dieser Aufteilung gehört nicht mehr zur Gruppe.",
  split_fixed_negative: "Ein Betrag der Aufteilung darf nicht negativ sein.",
  split_percent_negative:
    "Ein Prozentsatz der Aufteilung darf nicht negativ sein.",
  split_remainder_nobody: "Es ist niemand mehr da, der den Rest übernimmt.",
  split_both_amount_and_share:
    "Dieselbe Person steht sowohl für einen Betrag als auch für einen Prozentsatz.",
  ...
  confirm_leave_entry:
    "Verlassen und jene öffnen? Was hier eingegeben wurde, wird nicht gespeichert.",
  split: "Aufteilung",
  edit_split: "Ändern",
  done: "Fertig",
...
const NL: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "De koersdienst is niet bereikbaar. Voer een koers in om door te gaan: hij wordt bewaard voor de volgende keer.",
  rate_unknown_currency:
    "De koersdienst kent dit valutapaar niet. Voer een koers in om door te gaan: hij wordt bewaard voor de volgende keer.",
  ...
  split_percent_negative:
    "Een percentage in de verdeling kan niet negatief zijn.",
  split_remainder_nobody: "Er is niemand over om de rest te nemen.",
  split_both_amount_and_share:
    "Dezelfde persoon staat voor zowel een bedrag als een percentage.",
  ...
  confirm_leave_entry:
    "Weggaan en die openen? Wat hier is ingevuld, wordt niet bewaard.",
  split: "Verdeling",
  edit_split: "Wijzigen",
  done: "Klaar",
...
const ES: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "No se puede acceder al servicio de tipos. Introduce un tipo para continuar: servirá de referencia.",
  rate_unknown_currency:
    "El servicio de tipos no cubre este par de monedas. Introduce un tipo para continuar: servirá de referencia.",
  paid_by: "Pagado por",
  date: "Fecha",
  category: "Categoría",
  ...
  split_both_amount_and_share:
    "La misma persona figura a la vez por un importe y por un porcentaje.",
  ...
  confirm_leave_entry:
    "¿Salir y abrir aquel? Lo que se ha escrito aquí no se guarda.",
  split: "Reparto",
...
const IT: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "Il servizio dei tassi non è raggiungibile. Inserisci un tasso per continuare: servirà da riferimento.",
  rate_unknown_currency:
    "Il servizio dei tassi non copre questa coppia di valute. Inserisci un tasso per continuare: servirà da riferimento.",
  paid_by: "Pagato da",
  date: "Data",
  category: "Categoria",
  ...
  split_percent_negative:
    "Una percentuale della divisione non può essere negativa.",
  split_remainder_nobody: "Non resta nessuno a prendersi il resto.",
  split_both_amount_and_share:
    "La stessa persona è indicata sia per un importo sia per una percentuale.",
  ...
  confirm_leave_entry:
    "Uscire e aprire quella? Quanto è stato scritto qui non viene salvato.",
  split: "Ripartizione",
  edit_split: "Modifica",
  done: "Fatto",
...
const PL: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "Serwis kursów jest nieosiągalny. Wpisz kurs, aby kontynuować: zostanie zachowany na następny raz.",
  rate_unknown_currency:
    "Serwis kursów nie obsługuje tej pary walut. Wpisz kurs, aby kontynuować: zostanie zachowany na następny raz.",
  ...
  split_both_amount_and_share:
    "Ta sama osoba jest wpisana i na kwotę, i na udział procentowy.",
  ...
  confirm_leave_entry:
    "Wyjść i otworzyć tamten? To, co tu wpisano, nie zostanie zapisane.",
  split: "Podział",
  edit_split: "Zmień",
  done: "Gotowe",
...
const PT_BR: Record<Key, string> = {
  ...
  rate_service_unreachable:
    "O serviço de taxas está inacessível. Digite uma taxa para continuar: ela será guardada para a próxima vez.",
  rate_unknown_currency:
    "O serviço de taxas não cobre esse par de moedas. Digite uma taxa para continuar: ela será guardada para a próxima vez.",
  paid_by: "Pago por",
  date: "Data",
  category: "Categoria",
  ...
  split_both_amount_and_share:
    "A mesma pessoa está inscrita para um valor e para uma percentagem.",
  ...
  confirm_leave_entry:
    "Sair e abrir aquela? O que foi digitado aqui não é salvo.",
  split: "Divisão",
  edit_split: "Alterar",
  done: "Concluído",
